...
matrix_entries = [
    CTkEntry(
        master=matrix_form, width=5, placeholder_text=f"{gate.U[i // 2, i % 2]:.2f}"
    )
    for i in range(4)
]
...
button_quit = CTkButton(master=settings_bar, text="Quit", command=root.destroy)
